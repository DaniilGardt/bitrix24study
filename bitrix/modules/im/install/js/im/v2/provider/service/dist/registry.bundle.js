...
(function (exports,im_v2_lib_feature,im_public,im_v2_provider_service,imopenlines_v2_lib_openlines,call_lib_callTokenManager,im_v2_lib_roleManager,im_v2_lib_uuid,im_v2_lib_layout,im_v2_lib_copilot,ui_vue3_vuex,ui_notification,main_core,im_v2_lib_user,rest_client,im_v2_lib_utils,im_v2_lib_notifier,ui_uploader_core,im_v2_lib_logger,main_core_events,im_v2_lib_analytics,im_v2_application_core,im_v2_const,im_v2_lib_rest) {
	'use strict';
	...
	function _prepareChatForUser2(item) {
	  ...
	  return {
	    ...
	    optionalParams: (_item$chat = item.chat) == null ? void 0 : _item$chat.optional_params
	  };
	}
	...
	class ChatDataExtractor {
	  ...
	  getAutoDeleteConfig() {
	    return babelHelpers.classPrivateFieldLooseBase(this, _restResult$1)[_restResult$1].messagesAutoDeleteConfigs;
	  }
	}
	...
	class PinService {
	  ...
	  pinChat(dialogId) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$3)[_restClient$3].callMethod(im_v2_const.RestMethod.imRecentPin, queryParams).catch(result => {
	...
	class ReadService {
	  ...
	  readAll() {
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _restClient$4)[_restClient$4].callMethod(im_v2_const.RestMethod.imV2ChatReadAll).catch(result => {
	...
	class UserService {
	  ...
	  async kickUserFromChat(dialogId, userId) {
	    ...
	    await babelHelpers.classPrivateFieldLooseBase(this, _restClient$5)[_restClient$5].callMethod(im_v2_const.RestMethod.imV2ChatDeleteUser, queryParams).catch(result => {
	  ...
	  addToChat(addConfig) {
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _restClient$5)[_restClient$5].callMethod(im_v2_const.RestMethod.imChatUserAdd, queryParams).catch(result => {
	...
	class MessagesAutoDeleteService {
	  ...
	  setDelay(dialogId, hours) {
	    im_v2_lib_logger.Logger.warn('MessagesAutoDeleteService: setDelay', dialogId, hours);
	...
	function _sendRequest2(queryParams) {
	  const {
	    dialogId,
	    hours,
	    previousDelay
	  } = queryParams;
	  return im_v2_lib_rest.runAction(im_v2_const.RestMethod.imV2ChatSetMessagesAutoDeleteDelay, {
	    data: {
	      dialogId,
	      hours
	    }
	...
	class LoadService$1 {
	  ...
	  async loadUnread() {
	    ...
	    const lastUnreadMessageId = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].getters['messages/getLastId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId)[_chatId]);
	  ...
	  async loadHistory() {
	    ...
	    const lastHistoryMessageId = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].getters['messages/getFirstId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId)[_chatId]);
	  ...
	  drawPreparedHistoryMessages() {
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('messages/setChatCollection', {
	  ...
	  async loadFirstPage() {
	    ...
	    await babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('chats/update', {
	...
	function _prepareInitialMessages2(rawMessages) {
	  ...
	  const messagesCollection = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].getters['messages/getByChatId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId)[_chatId]);
	...
	function _handleLoadedMessages2(restResult) {
	  ...
	  const messagesPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('messages/setChatCollection', {
	    messages,
	    clearCollection: true
	  });
	...
	function _updateModels2$2(rawData) {
	  ...
	  const dialogPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('chats/update', {
	    dialogId: babelHelpers.classPrivateFieldLooseBase(this, _getDialog)[_getDialog]().dialogId,
	    fields: {
	      hasPrevPage,
	      hasNextPage,
	  ...
	  const filesPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('files/set', files);
	  const reactionsPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('messages/reactions/set', reactions);
	  const additionalMessagesPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('messages/store', additionalMessages);
	  const commentInfoPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].dispatch('messages/comments/set', commentInfo);
	  const copilotManager = new im_v2_lib_copilot.CopilotManager();
	...
	function _prepareTariffRestrictions2(restrictions) {
	  ...
	  const chat = babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].getters['chats/get'](dialogId);
	  if (!chat) {
	    return restrictions;
	  }
	  const {
	...
	function _getDialog2() {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$a)[_store$a].getters['chats/getByChatId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId)[_chatId]);
	}
	...
	class PinService$1 {
	  ...
	  pinMessage(chatId, messageId) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$b)[_store$b].dispatch('messages/pin/add', payload);
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$6)[_restClient$6].callMethod(im_v2_const.RestMethod.imV2ChatMessagePin, {
	      ...
	      void babelHelpers.classPrivateFieldLooseBase(this, _store$b)[_store$b].dispatch('messages/pin/delete', payload);
	    });
	  }
	...
	class DeleteService$1 {
	  ...
	  async deleteMessages(messageIds) {
	    ...
	    messageIds.forEach(messageId => {
	      ...
	      babelHelpers.classPrivateFieldLooseBase(this, _updateModels$3)[_updateModels$3](messageId);
	...
	function _updateModels2$3(messageId) {
	...
	function _completeMessageDelete2(message) {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _store$c)[_store$c].dispatch('messages/delete', {
	    id: message.id
	  });
	}
	function _updateRecentForCompleteDelete2(newLastId) {
	  const chat = babelHelpers.classPrivateFieldLooseBase(this, _getChat)[_getChat]();
	  if (!newLastId) {
	    babelHelpers.classPrivateFieldLooseBase(this, _store$c)[_store$c].dispatch('recent/delete', {
	      id: chat.dialogId
	    });
	    return;
	  }
	...
	function _deleteTemporaryMessage2(messageId) {
	  const chat = babelHelpers.classPrivateFieldLooseBase(this, _getChat)[_getChat]();
	  const recentItem = babelHelpers.classPrivateFieldLooseBase(this, _store$c)[_store$c].getters['recent/get'](chat.dialogId);
	...
	function _getPreviousMessageId2(messageId) {
	  ...
	  const previousMessage = babelHelpers.classPrivateFieldLooseBase(this, _store$c)[_store$c].getters['messages/getPreviousMessage']({
	    messageId,
	...
	function _getChat2() {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$c)[_store$c].getters['chats/getByChatId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId$1)[_chatId$1]);
	}
	...
	class MarkService {
	  ...
	  markMessage(messageId) {
	    ...
	    const {
	      dialogId
	    } = babelHelpers.classPrivateFieldLooseBase(this, _store$d)[_store$d].getters['chats/getByChatId'](babelHelpers.classPrivateFieldLooseBase(this, _chatId$2)[_chatId$2]);
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$d)[_store$d].dispatch('recent/unread', {
	      id: dialogId,
	      action: true
	    });
	...
	class FavoriteService {
	  ...
	  removeMessageFromFavorite(messageId) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$e)[_store$e].dispatch('sidebar/favorites/deleteByMessageId', {
	...
	class MessageService {
	  ...
	  reloadMessageList() {
	    babelHelpers.classPrivateFieldLooseBase(this, _loadService$1)[_loadService$1].reloadMessageList();
	  }
	  loadInitialMessages() {
	  ...
	  deleteMessages(messageIds) {
	    babelHelpers.classPrivateFieldLooseBase(this, _deleteService$1)[_deleteService$1].deleteMessages(messageIds);
	  }
	  // endregion 'delete'
	}
	...
	var _updateModels$4 = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("updateModels");
	...
	class SendingService$$1 {
	  ...
	  constructor() {
	    ...
	    Object.defineProperty(this, _updateModels$4, {
	      value: _updateModels2$4
	    });
	  ...
	  async retrySendMessage(params) {
	    ...
	    const unsentMessage = babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['messages/getById'](tempMessageId);
	    if (!unsentMessage) {
	      return Promise.resolve();
	    }
	...
	async function _addLoadingMessage2(message) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].dispatch('messages/addLoadingMessage', {
	    message
	  });
	}
	...
	async function _sendAndProcessMessage2(message) {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _updateModels$4)[_updateModels$4]({
	...
	async function _handlePagination2(dialogId) {
	  ...
	  await messageService.loadContext(babelHelpers.classPrivateFieldLooseBase(this, _getDialog$1)[_getDialog$1](dialogId).lastMessageId);
	  babelHelpers.classPrivateFieldLooseBase(this, _sendScrollEvent)[_sendScrollEvent]({
	    dialogId
	  });
	  return Promise.resolve();
	...
	function _updateModels2$4(params) {
	  const {
	    oldId,
	    newId,
	    dialogId
	  } = params;
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].dispatch('messages/updateWithId', {
	    id: oldId,
	    fields: {
	      id: newId
	    }
	  });
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].dispatch('chats/update', {
	    dialogId,
	    fields: {
	      lastId: newId,
	      lastMessageId: newId
	...
	function _getDialog2$1(dialogId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['chats/get'](dialogId, true);
	}
	function _getDialogByChatId2$1(chatId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['chats/getByChatId'](chatId, true);
	}
	function _needToSetAsViewed2(dialogId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['users/bots/isNetwork'](dialogId);
	}
	...
	function _prepareForwardMessages2(params, forwardUuidMap) {
	  ...
	  Object.entries(forwardUuidMap).forEach(([uuid, messageId]) => {
	    const message = babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['messages/getById'](messageId);
	    if (!message) {
	      return;
	    }
	...
	function _prepareForwardParams2(messageId) {
	  ...
	  const isForward = babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].getters['messages/isForward'](messageId);
	...
	function _clearLastMessageViews2(dialogId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$f)[_store$f].dispatch('chats/clearLastMessageViews', {
	    dialogId
	  });
	}
	...
	class DiskService {
	  ...
	  delete({
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _restClient$9)[_restClient$9].callMethod(im_v2_const.RestMethod.imDiskFileDelete, queryParams).catch(result => {
	...
	var _getChatId$1 = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("getChatId");
	...
	class UploadingService$$1 extends main_core_events.EventEmitter {
	  static getInstance() {
	    if (!this.instance) {
	      this.instance = new this();
	    }
	  ...
	  constructor() {
	    ...
	    Object.defineProperty(this, _getChatId$1, {
	      value: _getChatId2$1
	    });
	  ...
	  commitMessage(uploaderId) {
	    ...
	    const chatId = babelHelpers.classPrivateFieldLooseBase(this, _getChatId$1)[_getChatId$1](dialogId);
	...
	function _addFileFromDiskToModel2(messageWithFile) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('files/add', {
	...
	function _initUploader2() {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _uploaderWrapper)[_uploaderWrapper].subscribe(UploaderWrapper.events.onFileUploadStart, event => {
	    ...
	    this.emit(UploadingService$$1.event.uploadStart);
	  });
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _uploaderWrapper)[_uploaderWrapper].subscribe(UploaderWrapper.events.onFileUploadComplete, async event => {
	    ...
	    this.emit(UploadingService$$1.event.uploadComplete);
	  });
	  babelHelpers.classPrivateFieldLooseBase(this, _uploaderWrapper)[_uploaderWrapper].subscribe(UploaderWrapper.events.onFileUploadError, event => {
	    ...
	    this.emit(UploadingService$$1.event.uploadError);
	  });
	  babelHelpers.classPrivateFieldLooseBase(this, _uploaderWrapper)[_uploaderWrapper].subscribe(UploaderWrapper.events.onFileUploadCancel, event => {
	    ...
	    this.emit(UploadingService$$1.event.uploadCancel);
	  });
	}
	function _isMediaFile2(fileId) {
	  const mediaFileTypes = [im_v2_const.FileType.image, im_v2_const.FileType.video];
	  const file = babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['files/get'](fileId);
	  return Boolean(file) && mediaFileTypes.includes(file.type);
	}
	function _setFileMapping2(options) {
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('files/setTemporaryFileMapping', options);
	}
	function _requestDiskFolderId2(dialogId) {
	  return new Promise((resolve, reject) => {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$a)[_restClient$a].callMethod(im_v2_const.RestMethod.imDiskFolderGet, {
	      ...
	      babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].commit('chats/update', {
	        dialogId,
	        fields: {
	          diskFolderId
	        }
	...
	function _updateFileProgress2(id, progress, status) {
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('files/update', {
	    id,
	    fields: {
	...
	function _cancelUpload2(tempMessageId, tempFileId) {
	  const message = babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['messages/getById'](tempMessageId);
	  if (message) {
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('messages/delete', {
	      id: tempMessageId
	    });
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('files/delete', {
	      id: tempFileId
	    });
	    const chat = babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['chats/getByChatId'](message.chatId);
	    const lastMessageId = babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['messages/findLastChatMessageId'](message.chatId);
	    if (lastMessageId > -1) {
	      void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('recent/update', {
	        id: chat.dialogId,
	        fields: {
	      ...
	      void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('recent/delete', {
	        id: chat.dialogId
	      });
	    }
	  }
	...
	function _addFileToStore2(file) {
	  ...
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('files/add', {
	    id: taskId,
	...
	function _getDialog2$2(dialogId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['chats/get'](dialogId);
	}
	function _getCurrentUser2() {
	  const userId = im_v2_application_core.Core.getUserId();
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].getters['users/get'](userId);
	}
	function _getChatId2$1(dialogId) {
	  var _babelHelpers$classPr2;
	...
	function _setMessageError2(tempMessageId) {
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$g)[_store$g].dispatch('messages/update', {
	    id: tempMessageId,
	    fields: {
	      error: true
	    }
	...
	class InputSenderService {
	  ...
	  startAction(actionType) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _requestDelayMap)[_requestDelayMap][actionType] = setTimeout(() => {
	      babelHelpers.classPrivateFieldLooseBase(this, _sendRequest$1)[_sendRequest$1](actionType);
	    }, REQUEST_DELAY);
	  }
	...
	function _sendRequest2$1(actionType) {
	  const queryParams = {
	...
	exports.InputSenderService = InputSenderService;

}((this.BX.Messenger.v2.Service = this.BX.Messenger.v2.Service || {}),BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Service??{},BX?.OpenLines?.v2?.Lib??{},BX?.Call?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Vue3?.Vuex??{},BX??{},BX??{},BX?.Messenger?.v2?.Lib??{},BX??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.UI?.Uploader??{},BX?.Messenger?.v2?.Lib??{},BX?.Event??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Application??{},BX?.Messenger?.v2?.Const??{},BX?.Messenger?.v2?.Lib??{}));
